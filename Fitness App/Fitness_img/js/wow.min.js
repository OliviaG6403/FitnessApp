...
(function(a, b) {
    ...
    function g(a) {
      ...
      var d = arguments.length <= 3 || void 0 === arguments[3] ? null : arguments[3];
      var e = void 0;
    ...
    var q = window.getComputedStyle || function(a) {
      ...
      return {
        getPropertyValue: function(c) {
          if ("float" === c) c = "styleFloat";
          if (b.test(c)) c = c.replace(b, function(a, b) {
    ...
    var r = (function() {
      ...
      n(a, [
        ...
        },
        {
          key: "sync",
          value: function() {
            if (p.notSupported) this.doSync(this.element);
          }
        },
        {
          key: "doSync",
          value: function(a) {
            if ("undefined" != typeof a && null !== a) {
              if (a.nodeType === 1) {
                a = a.parentNode || a;
                for (var b = [].slice.call(a.querySelectorAll("." + this.config.boxClass)), c = 0; c < b.length; c++) {
                  var d = b[c];
                  if (this.all.indexOf(d) < 0) {
                    this.boxes.push(d);
                    this.all.push(d);
        ...
        },
        {
          ...
          value: function(a) {
            ...
            if (null != this.config.callback) this.config.callback(a);
            h(a, this.wowEvent);
        ...
        },
        {
          ...
          value: function(a, b, c, d, e) {
            if (b) this.cacheAnimationName(a);
            a.style.visibility = b ? "hidden" : "visible";
            if (c) this.vendorSet(a.style, { animationDuration: c });
            if (d) this.vendorSet(a.style, { animationDelay: d });
            if (e) this.vendorSet(a.style, { animationIterationCount: e });
